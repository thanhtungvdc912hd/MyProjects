...
export default class RestaurantDetail extends Component<{}> {
  ...
  render() {
    ...
    if (branches != null && branches.length > 1) {
      branchesJSX = (
        <TouchableOpacity style={styles.time} onPress={() => navigate('Restaurants', {branches})}>
    ...
    let benefitJSX = null
    if (restaurant.benefits != null && restaurant.benefits.length > 0) {
      benefitJSX = (
      ...
      <View style={styles.container}>
        ...
        <View style={styles.detail}>
          <View>
            ...
            <View style={styles.time}>
              <TouchableOpacity style={{flex:1, flexDirection:'row'}} onPress={()=> navigate('Foods',{foods})}>
